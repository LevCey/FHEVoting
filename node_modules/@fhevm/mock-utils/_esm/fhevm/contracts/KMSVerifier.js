...
export class KMSVerifier {
    constructor(runner, kmsVerifierContractAddress) {
        ...
        __classPrivateFieldSet(this, _KMSVerifier_kmsVerifierContract, new EthersT.Contract(kmsVerifierContractAddress, abiKMSVerifier, runner), "f");
    }
    get runner() {
        assertFhevm(__classPrivateFieldGet(this, _KMSVerifier_kmsVerifierContract, "f").runner);
