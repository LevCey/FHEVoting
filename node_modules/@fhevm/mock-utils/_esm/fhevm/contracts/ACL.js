...
export class ACL {
    constructor(runner, aclContractAddress) {
        ...
        __classPrivateFieldSet(this, _ACL_aclReadOnlyContract, new EthersT.Contract(aclContractAddress, abiACL, runner), "f");
    }
    get runner() {
        assertFhevm(__classPrivateFieldGet(this, _ACL_aclReadOnlyContract, "f").runner);
    ...
    async initialize() {
        assertFhevm(__classPrivateFieldGet(this, _ACL_fhevmExecutorAddress, "f") === undefined, `ACL wrapper already initialized`);
