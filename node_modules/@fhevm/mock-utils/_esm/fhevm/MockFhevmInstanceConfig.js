...
import { initFhevmContractsInfo } from "./contracts/index.js";
...
export class MockFhevmInstanceConfig {
    ...
    static async formConfig(config, options) {
        ...
        const contractsInfo = await initFhevmContractsInfo(__classPrivateFieldGet(mockConfig, _MockFhevmInstanceConfig_readonlyRunner, "f"), __classPrivateFieldGet(mockConfig, _MockFhevmInstanceConfig_aclContractAddress, "f"), __classPrivateFieldGet(mockConfig, _MockFhevmInstanceConfig_kmsContractAddress, "f"));
        if (contractsInfo.inputVerifier.address !== __classPrivateFieldGet(mockConfig, _MockFhevmInstanceConfig_inputVerifierContractAddress, "f")) {
            throw new FhevmError(`InputVerifier address mismatch: the ACL contract at '${config.aclContractAddress}' on network '${config.network}' (chainId: ${config.chainId}) is using InputVerifier at '${contractsInfo.inputVerifier.address}', but 'FhevmInstanceConfig.inputVerifierContractAddress' is set to '${config.inputVerifierContractAddress}'. Please update the configuration to match.`);
        }
    ...
    get contractsInfo() {
        assertFhevm(__classPrivateFieldGet(this, _MockFhevmInstanceConfig_contractsInfo, "f") !== undefined, "MockFhevmInstanceConfig is not initialized");
    ...
    get aclContractAddress() {
        assertFhevm(__classPrivateFieldGet(this, _MockFhevmInstanceConfig_aclContractAddress, "f") !== undefined, "MockFhevmInstanceConfig is not initialized");
        return __classPrivateFieldGet(this, _MockFhevmInstanceConfig_aclContractAddress, "f");
    }
    get kmsContractAddress() {
        assertFhevm(__classPrivateFieldGet(this, _MockFhevmInstanceConfig_kmsContractAddress, "f") !== undefined, "MockFhevmInstanceConfig is not initialized");
        return __classPrivateFieldGet(this, _MockFhevmInstanceConfig_kmsContractAddress, "f");
    }
    get inputVerifierContractAddress() {
        assertFhevm(__classPrivateFieldGet(this, _MockFhevmInstanceConfig_inputVerifierContractAddress, "f") !== undefined, "MockFhevmInstanceConfig is not initialized");
...
function _loadSignersCategory(signersCategory) {
    ...
    if (signersCategory.privateKeys) {
        ...
        const wallets = defaultWallets(signersCategory.default.initialIndex, signersCategory.threshold, signersCategory.default.path);
