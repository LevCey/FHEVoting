...
export class MockDecryptionOracle {
    constructor(decryptionOracleContractInterface, decryptionOracleContractAddress, readonlyProvider, coprocessor, db, kmsVerifier, acl, kmsSigners, relayerSigner) {
        ...
        __classPrivateFieldSet(this, _MockDecryptionOracle_readonlyProvider, readonlyProvider, "f");
        __classPrivateFieldSet(this, _MockDecryptionOracle_coprocessor, coprocessor, "f");
        __classPrivateFieldSet(this, _MockDecryptionOracle_iterator, new DecryptionOracleEventsIterator(decryptionOracleContractInterface, decryptionOracleContractAddress, readonlyProvider, db.fromBlockNumber), "f");
        __classPrivateFieldSet(this, _MockDecryptionOracle_handler, new DecryptionOracleEventsHandler(db, kmsVerifier, kmsSigners, relayerSigner), "f");
        __classPrivateFieldSet(this, _MockDecryptionOracle_acl, acl, "f");
        __classPrivateFieldSet(this, _MockDecryptionOracle_kmsVerifier, kmsVerifier, "f");
        __classPrivateFieldSet(this, _MockDecryptionOracle_kmsSigners, kmsSigners, "f");
    }
    async createDecryptionSignatures(handlesBytes32Hex, clearTextValues) {
        return (await computeDecryptionSignatures(handlesBytes32Hex, clearTextValues, EthersT.AbiCoder.defaultAbiCoder(), __classPrivateFieldGet(this, _MockDecryptionOracle_kmsVerifier, "f"), __classPrivateFieldGet(this, _MockDecryptionOracle_kmsSigners, "f"))).signatures;
    }
