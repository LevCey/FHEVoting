...
function defaultWallets(initialIndex, count, path, provider) {
    const wallets = [];
    for (let i = 0; i < count; ++i) {
        wallets.push(walletFromMnemonic(i + initialIndex, constants_js_1.default.TEST_MNEMONIC, path, provider ?? null));
    }
    return wallets;
}
