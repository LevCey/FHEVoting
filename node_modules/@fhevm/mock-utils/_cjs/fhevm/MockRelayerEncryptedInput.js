...
var _MockRelayerEncryptedInput_clearTextValues, _MockRelayerEncryptedInput_fhevmTypes, _MockRelayerEncryptedInput_fheTypes, _MockRelayerEncryptedInput_totalFheBits, _MockRelayerEncryptedInput_contractChainId, _MockRelayerEncryptedInput_contractAddress, _MockRelayerEncryptedInput_userAddress, _MockRelayerEncryptedInput_provider, _MockRelayerEncryptedInput_aclContractAddress, _MockRelayerEncryptedInput_inputVerifier;
...
class MockRelayerEncryptedInput {
    constructor(provider, contractChainId, contractAddress, userAddress, aclContractAddress, inputVerifier) {
        ...
        _MockRelayerEncryptedInput_provider.set(this, void 0);
        ...
        __classPrivateFieldSet(this, _MockRelayerEncryptedInput_provider, provider, "f");
    ...
    toMockFhevmRelayerV1InputProofPayload() {
        ...
        const mockCiphertextWithInputVerification = MockRelayerEncryptedInput.computeMockCiphertextWithZKProof(clearTextValuesBigInt, __classPrivateFieldGet(this, _MockRelayerEncryptedInput_fheTypes, "f"), rand32BufferList);
        const mockData = {
    ...
    static computeMockCiphertextWithZKProof(clearTextValuesBigInt, fheTypes, rand32BufferList) {
    ...
    async encrypt() {
        ...
        const response = await (0, MockRelayer_js_1.requestRelayerV1InputProof)(__classPrivateFieldGet(this, _MockRelayerEncryptedInput_provider, "f"), payload);
...
_MockRelayerEncryptedInput_clearTextValues = new WeakMap(), _MockRelayerEncryptedInput_fhevmTypes = new WeakMap(), _MockRelayerEncryptedInput_fheTypes = new WeakMap(), _MockRelayerEncryptedInput_totalFheBits = new WeakMap(), _MockRelayerEncryptedInput_contractChainId = new WeakMap(), _MockRelayerEncryptedInput_contractAddress = new WeakMap(), _MockRelayerEncryptedInput_userAddress = new WeakMap(), _MockRelayerEncryptedInput_provider = new WeakMap(), _MockRelayerEncryptedInput_aclContractAddress = new WeakMap(), _MockRelayerEncryptedInput_inputVerifier = new WeakMap();
