...
class MockCoprocessor {
    constructor(coprocessorContractInterface, coprocessorContractAddress, readonlyProvider, db, inputVerifier, coprocessorSigners) {
        ...
        __classPrivateFieldSet(this, _MockCoprocessor_iterator, new CoprocessorEventsIterator_js_1.CoprocessorEventsIterator(coprocessorContractInterface, coprocessorContractAddress, readonlyProvider, db.fromBlockNumber), "f");
        __classPrivateFieldSet(this, _MockCoprocessor_handler, new CoprocessorEventsHandler_js_1.CoprocessorEventsHandler(db), "f");
        __classPrivateFieldSet(this, _MockCoprocessor_db, db, "f");
        __classPrivateFieldSet(this, _MockCoprocessor_inputVerifier, inputVerifier, "f");
        __classPrivateFieldSet(this, _MockCoprocessor_coprocessorSigners, coprocessorSigners, "f");
    }
