...
class KMSVerifier {
    constructor(runner, kmsVerifierContractAddress) {
        ...
        __classPrivateFieldSet(this, _KMSVerifier_kmsVerifierContractAddress, kmsVerifierContractAddress, "f");
        __classPrivateFieldSet(this, _KMSVerifier_kmsVerifierContract, new ethers_1.ethers.Contract(kmsVerifierContractAddress, abiKMSVerifier, runner), "f");
    }
    get runner() {
        (0, error_js_1.assertFhevm)(__classPrivateFieldGet(this, _KMSVerifier_kmsVerifierContract, "f").runner);
        return __classPrivateFieldGet(this, _KMSVerifier_kmsVerifierContract, "f").runner;
    }
    static async create(runner, kmsVerifierContractAddress) {
