...
export declare class MockRelayerEncryptedInput implements RelayerEncryptedInput {
    ...
    constructor(provider: MinimalProvider, contractChainId: number, contractAddress: string, userAddress: string, aclContractAddress: string, inputVerifier: InputVerifier);
    ...
    private toMockFhevmRelayerV1InputProofPayload;
