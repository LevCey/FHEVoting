...
class FhevmDebugger {
    ...
    async createDecryptionSignatures(handlesBytes32Hex, clearTextValues) {
        return await __classPrivateFieldGet(this, _FhevmDebugger_fhevmEnv, "f").decryptionOracle.createDecryptionSignatures(handlesBytes32Hex, clearTextValues);
    }
    createHandleCoder() {
        return new mock_utils_1.FhevmHandleCoder(__classPrivateFieldGet(this, _FhevmDebugger_fhevmEnv, "f").getACLAddress(), __classPrivateFieldGet(this, _FhevmDebugger_fhevmEnv, "f").chainId);
    }
    async decryptEbool(handleBytes32) {
        ...
        mock_utils_1.FhevmHandle.verify(handleBytes32Hex, {
            ...
            chainId: __classPrivateFieldGet(this, _FhevmDebugger_fhevmEnv, "f").ethersProvider.chainId,
        });
        const clearTextHexList = await mock_utils_1.relayer.requestFhevmGetClearText(__classPrivateFieldGet(this, _FhevmDebugger_fhevmEnv, "f").hre.ethers.provider, [
            handleBytes32Hex,
        ]);
    ...
    async decryptEuint(fhevmType, handleBytes32) {
        ...
        const handleBytes32Hex = ethers_1.ethers.toBeHex(handleBytes32, 32);
        mock_utils_1.FhevmHandle.verify(handleBytes32Hex, { fhevmType, chainId: __classPrivateFieldGet(this, _FhevmDebugger_fhevmEnv, "f").ethersProvider.chainId });
        const clearTextHexList = await mock_utils_1.relayer.requestFhevmGetClearText(__classPrivateFieldGet(this, _FhevmDebugger_fhevmEnv, "f").hre.ethers.provider, [
            handleBytes32Hex,
        ]);
        (0, error_2.assertHHFhevm)(clearTextHexList.length === 1);
