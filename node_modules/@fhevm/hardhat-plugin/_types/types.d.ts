import { CoprocessorEvent, DecryptionRequestEvent, FhevmContractName, FhevmHandleCoder, FhevmTypeEbytes, FhevmTypeEuint } from "@fhevm/mock-utils";
import type { DecryptedResults, EIP712, FhevmInstance, HandleContractPair, RelayerEncryptedInput } from "@zama-fhe/relayer-sdk/node";
...
export interface HardhatFhevmRuntimeEnvironment {
    ...
    userDecryptEbool(handleBytes32: string, contractAddress: AddressLike, user: Signer, options?: FhevmUserDecryptOptions): Promise<boolean>;
    userDecryptEuint(fhevmType: FhevmTypeEuint, handleBytes32: string, contractAddress: AddressLike, user: Signer, options?: FhevmUserDecryptOptions): Promise<bigint>;
    userDecryptEbytes(fhevmType: FhevmTypeEbytes, handleBytes32: string, contractAddress: AddressLike, user: Signer, options?: FhevmUserDecryptOptions): Promise<bigint>;
    userDecryptEaddress(handleBytes32: string, contractAddress: AddressLike, user: Signer, options?: FhevmUserDecryptOptions): Promise<string>;
}
